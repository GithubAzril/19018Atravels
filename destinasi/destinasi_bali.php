            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Pantai Kuta
                        </h2>
                        <div class="flex justify-between items-center my-2">
                            <span class="text-lg font-bold text-blue-600">Rp 15000</span>
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Pantai Kuta " data-normal-price="15000" data-vip-price="300000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/bali.png" alt="Burj Khalifa" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Tegallalang Rice Terrace</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Tegallalang Rice Terrace" data-normal-price="100000" data-vip-price="200000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/bali1.png" alt="Atlantis Aquaventure" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Monkey Forest Ubud</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Monkey Forest Ubud" data-normal-price="120000" data-vip-price="240000">Pesan Sekarang</a>
                    </div>
                </div>
    </section>
