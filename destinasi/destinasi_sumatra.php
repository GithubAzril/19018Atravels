...
<header>
                ...
                <div class="language-container" style="position: relative;">
                    ...
                    <div id="language-options" class="hidden">
                        <div class="bg-white text-black text-start mt-2 rounded shadow">
                            <a href="#" class="language-option block rounded-t border-black py-1 px-4" data-lang="id">Indonesia</a>
    ...
    <section class=" bg-[url('../gambar/hotel_sumatra.png')] dark:bg-[url('../gambar/hotel_sumatra.png')] bg-cover pt-20 pb-16">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative">
            ...
            <div class="absolute start-2 pr-2 top-full transform-translate-x-1/2 bg-white p-4 rounded-xl shadow-lg flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 rounded-xl sm:flex">
