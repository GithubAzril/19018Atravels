...
<header>
    ...
    <section class=" bg-[url('../gambar/hotel-papua.png')] dark:bg-[url('../gambar/hotel-papua.png')] bg-cover pt-20 pb-16">
        ...
        <div class="container mx-auto p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel-papua.png" alt="Ski Dubai" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Asana Biak Papua</h2>
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-hotel="Asana Biak Papua" data-normal-price="700000" data-vip-price="1400000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel-papua (1).png" alt="Burj Khalifa" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Swiss-Belhotel Papua</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-hotel="Swiss-Belhotel Papua" data-normal-price="500000" data-vip-price="1000000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel papua.png" alt="Atlantis Aquaventure" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Swiss-Belhotel Jayapura</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-hotel="Mercure Jayapura" data-normal-price="600000" data-vip-price="1200000">Pesan Sekarang</a>
                    </div>
                </div>
    </section>
