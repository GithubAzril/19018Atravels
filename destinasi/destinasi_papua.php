            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Raja Ampat </h2>
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Raja Ampat " data-normal-price="70000" data-vip-price="140000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel-papua (1).png" alt="Burj Khalifa" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Danau Paniai  </h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Danau Paniai " data-normal-price="50000" data-vip-price="100000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel papua.png" alt="Atlantis Aquaventure" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Teluk Toran</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Teluk Toran" data-normal-price="60000" data-vip-price="120000">Pesan Sekarang</a>
                    </div>
                </div>
    </section>
