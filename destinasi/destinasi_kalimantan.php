    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-4 md:mx-auto py-2 pr-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            <div class="flex flex-col p-4 md:p-0 mt-2 font-semibold md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-3">
                <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 md:dark:" aria-current="page">Beranda</a>
                ...
                <a href="#footer" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 md:dark:" id="about-us-link" aria-current="page">Tantang Kami</a>
            </div>
        </div>
    </div>
</nav>
    </header>
    <section class=" bg-[url('../gambar/bg-hotel-mercu.png')] dark:bg-[url('../gambar/bg-hotel-mercu.png')] bg-cover pt-20 pb-16">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative pb-12">
            ...
            <div class="absolute start-2 pr-2 top-full  transform-translate-x-1/2 bg-white p-4 flex flex-col shadow-lg sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 rounded-xl sm:flex">
        ...
        <div class="container mx-auto p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel mercure.png" alt="Ski Dubai" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Taman Nasional Tanjung Puting</h2>
                        <div class="flex justify-between items-center my-2">
                            <span class="text-lg font-bold text-blue-600">Rp 500.000</span>
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Taman Nasional Tanjung Puting" data-normal-price="50000" data-vip-price="100000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel-kalimantan.png" alt="Burj Khalifa" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Pantai Melawai</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Pantai Melawai" data-normal-price="70000" data-vip-price="140000">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <img src="../gambar/hotel-kalimantan (2).png" alt="Atlantis Aquaventure" class="w-full h-48 object-cover">
                    <div class="p-4 flex-grow">
                        <h2 class="text-xl font-semibold">Taman Nasional Danau Sentarum</h2>
                        <div class="flex justify-between items-center my-2">
                    ...
                    <div class="p-4 text-center">
                        <a href="#" class="pesan-button inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors" data-destinasi="Taman Nasional Danau Sentarum" data-normal-price="60000" data-vip-price="120000">Pesan Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
